// script.js - 𝐉𝐎𝐇𝐀𝐍 | 𝐘𝐔𝐆𝐈 𝐁𝐎𝐓

// ========== 1. تأثير الأرقام النازلة (Matrix) ==========
...
// إضافة الصوت لكل العناصر اللي عليها class 'click-sound'
...
// ========== 5. عدادات الإحصائيات المتعددة ==========
function animateStats() {
    const stats = [
        { id: 'yearsExp', target: 4 },
        { id: 'projectsCount', target: 45 },
        { id: 'clientsCount', target: 280 },
        { id: 'botsCount', target: 15 },
        { id: 'hoursCount', target: 3500 },
        { id: 'countriesCount', target: 12 }
    ];
...
// ========== 7. تأثير ظهور العناصر عند التمرير ==========
function addScrollReveal() {
    const cards = document.querySelectorAll('.skill-card, .project-card, .link-card, .testimonial-card, .faq-card, .stat-card');
